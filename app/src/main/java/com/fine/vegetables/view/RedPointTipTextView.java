...
public class RedPointTipTextView extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mPointVisibility == VISIBLE) {
            ...
            canvas.drawCircle(width - getPaddingRight() / 2, paddingRight, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4, getResources().getDisplayMetrics()), mPointPaint);
        } else {
