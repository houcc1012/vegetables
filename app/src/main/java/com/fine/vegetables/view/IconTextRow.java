...
public class IconTextRow extends LinearLayout {
    ...
    private onRightImageOnClickListener mRightImageOnClickListener;

    private Paint mPaint;
    private float mSplitLineHeight;
    private int mRowTextStyle;
    ...
    private void processAttrs(AttributeSet attrs) {
        ...
        mRowTextStyle = typedArray.getInt(R.styleable.IconTextRow_rowTextStyle, 0);
        ...
        if (mSplitLineColor == null) {
            mSplitLineColor = ColorStateList.valueOf(ContextCompat.getColor(getContext(), android.R.color.darker_gray));
        }
    ...
    private void init() {
        ...
        mTextView.setTypeface(mTextView.getTypeface(), mRowTextStyle);
            ...
            mRightImage.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mRightImageOnClickListener != null) {
                        mRightImageOnClickListener.onClick(v);
                    }
                }
            });
            addView(mRightImage);
    ...
    public void setOnRightImageOnClickListener(onRightImageOnClickListener onRightImageOnClickListener) {
        mRightImageOnClickListener = onRightImageOnClickListener;
    }
